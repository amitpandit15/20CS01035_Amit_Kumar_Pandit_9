...
#line 1137 "y.tab.c"
  ...
  case 3: /* E: E '+' T  */
#line 38 "AST.y"
         { node *PlusNode = createNode(1, 0, (yyvsp[-2].Node), (yyvsp[0].Node)); (yyval.Node) = PlusNode; }
#line 1143 "y.tab.c"
    break;

  case 4: /* E: E '-' T  */
#line 39 "AST.y"
         { node *MinusNode  = createNode(1, 1, (yyvsp[-2].Node), (yyvsp[0].Node)); (yyval.Node) = MinusNode; }
#line 1149 "y.tab.c"
    break;
...
#line 1155 "y.tab.c"
  ...
  case 6: /* T: T '*' F  */
#line 42 "AST.y"
         { node *MulNode = createNode(1, 2, (yyvsp[-2].Node), (yyvsp[0].Node)); (yyval.Node) = MulNode; }
#line 1161 "y.tab.c"
    break;
...
#line 1195 "y.tab.c"
  ...
  case 10: /* F: NUMBER  */
#line 63 "AST.y"
          { node *NumNode = createNode(0, (yyvsp[0].Value), NULL, NULL); (yyval.Node) = NumNode; }
#line 1201 "y.tab.c"
    break;
